        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 mb-5">
                    <div class="blog-item">
                        <img loading="lazy" src="{{asset('assets/front/images/blog/1.jpg') }}" alt="blog"
                ...
                <div class="col-lg-6 col-md-6 mb-5">
                    <div class="blog-item">
                        <img loading="lazy" src="{{asset('assets/front/images/blog/2.jpg') }}" alt="blog"
                             class="img-fluid rounded">
                ...
                <div class="col-lg-6 col-md-6 mb-5">
                    <div class="blog-item">
                        <img loading="lazy" src="{{asset('assets/front/images/blog/3.jpg') }}" alt="blog"
                             class="img-fluid rounded">
                        ...
                        <div class="blog-item-content bg-white p-5">
                            ...
                            <h3 class="mt-3 mb-3"><a href="blog-single.html">Marketing Strategy to bring more affect</a>
                            </h3>
                            <p class="mb-4">Non illo quas blanditiis repellendus laboriosam minima animi. Consectetur
                                accusantium
                                pariatur repudiandae!</p>
                ...
                <div class="col-lg-6 col-md-6 mb-5">
                    <div class="blog-item">
                        <img loading="lazy" src="{{asset('assets/front/images/blog/4.jpg') }}" alt="blog"
                             class="img-fluid rounded">
